...
% 2022-04-25T09:30, 9850 words, 19.5 pages
...
from the start. Having the next steps follow on so naturally from the current
implementation aligns very well with this project's main goal of being a gentle
introduction to \gls{os} development.
...
for in the original project plan.

\paragraph{Debug shell vs GDB}
The first is not so much an issue as it is a
