...
\begin{itemize}
    \item \href{https://github.com/jncronin/rpi-boot}{rpi-boot}: A second
        stage bootloader for the \gls{rpi}.
    \item \href{https://github.com/s-matyukevich/raspberry-pi-os}{raspberry-pi-os}:
        Learning \gls{os} development using Linux kernel and \gls{rpi}.
    \item \href{https://github.com/bztsrc/raspi3-tutorial}{raspi3-tutorial}:
        Bare metal \gls{rpi} 3 tutorials.
    \item \href{https://github.com/torvalds/linux}{The Linux kernel}.
    \item \href{https://github.com/NetBSD/src}{NetBSD} (and the rest of the
        BSDs).
    \item \href{https://www.riscosopen.org/content/}{RiscOS}.
\end{itemize}
